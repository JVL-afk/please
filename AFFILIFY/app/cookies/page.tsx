export const metadata = {
  title: 'Cookie Policy | AFFILIFY',
  description: 'Learn about how AFFILIFY uses cookies and similar technologies to improve your experience.',
}
    ...
    <main className="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <p>
            If you have any questions about our use of cookies or other technologies, please email us at privacy@affilify.eu or contact us at:
          </p>
          <p className="mt-4">
            AFFILIFY<br />
